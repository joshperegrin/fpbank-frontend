  ...
  <ion-page>
    <ion-content class="ion-padding padding-top" :fullscreen="true">
      <div v-if="this.loaded" class="content-container">
        ...
        <div class="detail-list"><div> Biller Name and REF# </div> <div> {{this.transactionDetails.ewallet_EWalletName}}: {{this.transactionDetails.ewallet_WalletNumber}}</div></div>
...
export default {
  ...
  methods: {
    async processTransaction(){
      const fetchedTransactionDetails = await this.servicesStore.loadEwallet();
      ...
      this.transactionDetails.ewallet_EWalletName = this.servicesStore.serviceDetails.ewallet_EWalletName
      this.transactionDetails.ewallet_WalletNumber = this.servicesStore.serviceDetails.ewallet_WalletNumber

      this.transactionDetails.transferFrom = this.accountNumber
      
      this.transactionDetails.amount = this.servicesStore.serviceDetails.ewallet_Amount
      this.loaded = true;
