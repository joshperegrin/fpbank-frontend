  ...
  <ion-page>
    ...
    <ion-content class="ion-padding">
      <div class="content-container">
        <div class="ion-activatable transfer" @click="this.$router.push(`/tabs/tab2/transfer/ewallet/destinationSelect/ewalletSelect`)">
          <ion-ripple-effect></ion-ripple-effect>
            <span v-if="!(this.servicesStore.serviceDetails.ewallet_EWalletName && this.servicesStore.serviceDetails.ewallet_EWalletName.trim() !== '')">Select Ewallet</span>
            <span v-else>{{this.servicesStore.serviceDetails.ewallet_EWalletName}}</span>
...
export default {
  ...
  mounted(){
    this.refNumber = this.servicesStore.serviceDetails.ewallet_WalletNumber;
  },
  methods: {
    cancel(){
    ...
    async confirm(){
      if(this.servicesStore.serviceDetails.ewallet_EWalletName !== "" &&
        this.refNumber !== "") {
          this.servicesStore.serviceDetails.ewallet_WalletNumber = this.refNumber;
          this.$router.back();
      } else {
        if(this.refNumber === ""){
        ...
        if(this.servicesStore.serviceDetails.ewallet_EWalletName === "" ||  this.refNumber === ""){
